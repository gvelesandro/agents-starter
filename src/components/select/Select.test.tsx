...
describe("Select", () => {
  ...
  it("shows selected value", () => {
    const setValue = vi.fn();
    render(
      <Select options={mockOptions} setValue={setValue} value="option2" />
    );
  ...
  it("applies small size classes", () => {
    const setValue = vi.fn();
    render(
      <Select options={mockOptions} setValue={setValue} value="" size="sm" />
    );
    const select = screen.getByRole("combobox");
  ...
  it("applies medium size classes", () => {
    const setValue = vi.fn();
    render(
      <Select options={mockOptions} setValue={setValue} value="" size="md" />
    );
    const select = screen.getByRole("combobox");
  ...
  it("applies correct background image styling based on size", () => {
    ...
    const { rerender } = render(
      <Select options={mockOptions} setValue={setValue} value="" size="base" />
    );
