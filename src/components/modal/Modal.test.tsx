...
describe('Modal', () => {
  ...
  it('has proper modal structure and styling', () => {
    ...
    expect(backdrop).toHaveClass('fixed', 'top-0', 'left-0', 'h-full', 'w-full', 'bg-black/5', 'backdrop-blur-[2px]')
  ...
  it('modal has correct z-index and positioning', () => {
    ...
    expect(modalContainer).toHaveClass('z-50', 'flex', 'h-screen', 'w-full', 'items-center', 'justify-center')
  })
