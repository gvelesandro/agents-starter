...
describe("MemoizedMarkdown", () => {
  ...
  it("applies correct wrapper class", () => {
    const { container } = render(
      <MemoizedMarkdown content="Test content" id="test-3" />
    );
  ...
  it("memoizes correctly with same content", () => {
    const { rerender } = render(
      <MemoizedMarkdown content="Same content" id="test-memo" />
    );
  ...
  it("re-renders when content changes", () => {
    const { rerender } = render(
      <MemoizedMarkdown content="Original content" id="test-change" />
    );
