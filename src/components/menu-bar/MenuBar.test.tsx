...
describe("MenuBar", () => {
  ...
  it("renders menu bar with navigation element", () => {
    renderWithProvider(<MenuBar isActive={1} options={mockOptions} />);
  ...
  it("applies active styling to active option", () => {
    renderWithProvider(
      <MenuBar isActive={2} options={mockOptions} optionIds={true} />
    );
  ...
  it("calls onClick when option is clicked", async () => {
    ...
    renderWithProvider(<MenuBar isActive={1} options={options} />);
  ...
  it("uses array index when optionIds is false", () => {
    renderWithProvider(
      <MenuBar isActive={1} options={mockOptions} optionIds={false} />
    );
  ...
  it("handles different isActive types", () => {
    const { rerender } = renderWithProvider(
      <MenuBar isActive="test" options={mockOptions} optionIds={true} />
    );
    ...
    rerender(
      <TooltipProvider>
        <MenuBar isActive={true} options={mockOptions} optionIds={true} />
      </TooltipProvider>
    );
  ...
  it("renders with no active option", () => {
    renderWithProvider(<MenuBar isActive={undefined} options={mockOptions} />);
  ...
  it("handles empty options array", () => {
    renderWithProvider(<MenuBar isActive={1} options={[]} />);
