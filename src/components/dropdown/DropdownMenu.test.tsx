...
vi.mock('@radix-ui/react-dropdown-menu', () => ({
  ...
  Trigger: ({ children, className, disabled, id }: any) => (
    <button data-testid="dropdown-trigger" className={className} disabled={disabled} id={id}>
      {children}
    </button>
  ),
  Portal: ({ children }: { children: React.ReactNode }) => <div data-testid="dropdown-portal">{children}</div>,
  Content: ({ children, className, align, side, sideOffset, alignOffset, onCloseAutoFocus }: any) => (
    <div 
...
vi.mock('@phosphor-icons/react', () => ({
  DotsThree: ({ weight }: { weight?: string }) => <span data-testid="dots-icon" data-weight={weight}>⋯</span>,
  IconContext: {
