...
describe("Avatar", () => {
  ...
  it("applies correct size classes", () => {
    ...
    const { container: baseContainer } = render(
      <Avatar username="john" size="base" />
    );
  ...
  it("applies toggled state with image", () => {
    const { container } = render(
      <Avatar username="john" image="/test.jpg" toggled />
    );
  ...
  it("renders with custom className", () => {
    const { container } = render(
      <Avatar username="john" className="custom-class" />
    );
  ...
  it("renders with href as link", () => {
    const { container } = render(
      <Avatar username="john" href="/profile" as="a" />
    );
  ...
  it("applies external link attributes", () => {
    const { container } = render(
      <Avatar username="john" href="/profile" external as="a" />
    );
    const element = container.firstChild as HTMLElement;
  ...
  it("calculates correct image dimensions based on size", () => {
    const { rerender } = render(
      <Avatar username="john" image="/test.jpg" size="sm" />
    );
